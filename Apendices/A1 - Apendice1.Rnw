...
<<global, eval=FALSE, echo=TRUE, size="footnotesize", code = readLines("Apendices/App/global.R")>>=
...
<<ui, echo=TRUE, eval=FALSE,size="footnotesize", code = readLines("Apendices/App/ui.R")>>=
...
<<server, echo=TRUE, eval=FALSE,size="footnotesize", code = readLines("Apendices/App/server.R")>>=
